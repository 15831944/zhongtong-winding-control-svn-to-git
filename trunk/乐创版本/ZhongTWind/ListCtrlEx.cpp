...
void CListCtrlEx::DisplayComboBox( CRect& crRect_i, CString csValues_i )
{
    ...
    Tokenize(csValues_i,(WCHAR *)SEPERATOR_STRING,csarValues );
...
{	
    csValues_o = _T("");
	for (int nIndex = 0; nIndex < csarValues_i.GetSize()-1; ++nIndex)
	{
